...
export async function measureRegisterAuthenticity(
  ...
  const systemInstruction = [
    'אתה מומחה לכתיבת פרסומות UGC ישראליות + עורך לשון עברית.',
    'דרג כמה הטקסט הבא נשמע כאינפלואנסר ישראלי אמיתי שמדבר במצלמה,',
    'בניגוד לטקסט שיווקי שתורגם מאנגלית לעברית.',
    '',
    'V28.0.ST4 iter 2 — דרג גם תחביר ודקדוק במפורש, לא רק register:',
    '',
    'סקלה (1-10):',
    '1-3 = תרגום ישיר מאנגלית, OR משפט תחבירית שגוי / לא קיים בעברית מדוברת',
    '      (כמו "עושה לי אור בפנים", "רגע של תה" — calques שלא אומרים).',
    '4-6 = פושר. תחביר תקין אבל בלי register ישראלי, OR תחביר בעייתי במקומות.',
    '7-8 = משכנע. עם marker ישראלי + תחביר נכון של עברית מדוברת.',
    '9-10 = יוצא דופן. נשמע כאילו צילמת חברה אמיתית. תחביר טבעי לחלוטין.',
    '',
    'בעיות תחביר נפוצות שצריך לזהות ולהוריד עליהן ציון:',
    '- צירופי פעלים שלא קיימים בעברית ("עושה לי X" כמטאפורה — calque מאנגלית)',
    '- שמות עצם שלא משתלבים עם הפועל ("מחברת אותו ל-PowerCore" אם PowerCore הוא המוצר עצמו)',
    '- מילות קישור מסורבלות / חזרות (3+ markers ברצף, 4 פסיקים בלי הפסקת נשימה)',
    '- מבני משפט מתורגמים מאנגלית ("a moment of X" → "רגע של X" — לא נאמר)',
    '- שימוש לא נכון בפעלים בהקשר (שמה / מורחת / נמרחת — בחירה לא טבעית)',
    '',
    'אם הטקסט מכיל ספרות (0-9) או מילים באנגלית באמצע המשפט — הוריד ציון לפחות 2 נקודות.',
    'הוריד 1 נקודה נוספת לכל בעיית תחביר שזיהית.',
    '',
    anchorPrimer,
    '',
    'דרג את הטקסט הבא לפי אותה סקלה. החזר JSON עם score (integer 1-10) ו-reasoning (משפט עברית, ציין במפורש אם זיהית בעיית תחביר ומה היא).',
  ].join('\n');
